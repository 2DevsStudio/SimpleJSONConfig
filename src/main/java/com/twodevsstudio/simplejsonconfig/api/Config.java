...
public abstract class Config {
  ...
  @Setter @Getter private static ConfigType type = ConfigType.JSON;
  ...
  /**
   * You can perform a dynamic reload for your configuration to apply changes performed manually
